...
function getIpInfo() {
  ...
  $.ajax({
    ...
    data: {
<<<<<<< HEAD
      key: '25TBZ-N5YKG-XU4QT-QSTJF-5D657-63FGT', 
=======
      key: 'T3EBZ-TJ7LI-YRBG2-5ZLUR-KD3OS-U6BJO',  // 这里要写你的KEY!!!
>>>>>>> 7f504d2960edf632c064b29f5e456471f9c51307
      output: 'jsonp',
    },
    dataType: 'jsonp',
    success: function (data) {
      if (data.status === 0) {
        ...
        fetch(`https://geoapi.qweather.com/v2/city/lookup?location=${encodeURIComponent(city)}&key=d76017d24b274c168618f2c411f0886a`)
          .then(res => res.json())
          .then(data => {
            if (data.code === "200") {
